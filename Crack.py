...
def banner():
	cetak(panel(f"""[bold red]
		 ██████╗██████╗ ██╗  ██╗ ██████╗██╗  ██╗
           ...
           ██║     ██╔══██╗╚════██║██║     ██╔═██╗ 
             ╚██████╗██║  ██║     ██║╚██████╗██║  ██╗
              ╚═════╝╚═╝  ╚═╝     ╚═╝ ╚═════╝╚═╝  ╚═╝""",width=90,title=f"LOGO ANDA",style=f"bold cyan"))
#--------------------[ BAGIAN-MASUK ]--------------#
def login():
	try:
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				#tree.add(f"[bold green][🎮][bold green]{apk}\n")
				#tree.add(f"[bold yellow][🎮][bold yellow]{apk}\n")
				cetak(tree) 
...
if __name__=='__main__':
    ...
    [bold red]      ██║     ██╔══██╗╚════██║██║     ██╔═██╗ 
    [bold red]        ╚██████╗██║  ██║     ██║╚██████╗██║  ██╗
    [bold red]         ╚═════╝╚═╝  ╚═╝     ╚═╝ ╚═════╝╚═╝  ╚═╝	""",width=90,title=f"[bold green]LOGO ANDA",style=f"bold cyan"))
	login()
